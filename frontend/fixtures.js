...
const caps = {
  ...
  'browserstack.username': process.env.BROWSERSTACK_USERNAME || 'juancarlosalonso_i1Tc3S',
  'browserstack.accessKey':
    process.env.BROWSERSTACK_ACCESS_KEY || 'rGm7C495SyhGpA964kYc',
...
exports.BS_LOCAL_ARGS = {
  key: process.env.BROWSERSTACK_ACCESS_KEY || 'rGm7C495SyhGpA964kYc',
};
